...
public final class SM4Util {
    ...
    private SM4Util() { }
    public static byte[] encrypt(byte[] plainText, byte[] key) throws Exception { return crypt(Cipher.ENCRYPT_MODE, plainText, key); }
    public static byte[] decrypt(byte[] cipherText, byte[] key) throws Exception { return crypt(Cipher.DECRYPT_MODE, cipherText, key); }
